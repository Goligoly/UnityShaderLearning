...
(_u_xlat1.y = dot(_in_NORMAL0.xyz, _hlslcc_mtx4x4unity_WorldToObject[0].xyz));
(_u_xlat1.z = dot(_in_NORMAL0.xyz, _hlslcc_mtx4x4unity_WorldToObject[1].xyz));
(_u_xlat1.x = dot(_in_NORMAL0.xyz, _hlslcc_mtx4x4unity_WorldToObject[2].xyz));
(_u_xlat12 = dot(_u_xlat1.xyz, _u_xlat1.xyz));
(_u_xlat12 = rsqrt(_u_xlat12));
(_u_xlat1.xyz = (vec3_ctor(_u_xlat12) * _u_xlat1.xyz));
(_u_xlat2.xyz = (_in_TANGENT0.yyy * _hlslcc_mtx4x4unity_ObjectToWorld[1].yzx));
(_u_xlat2.xyz = ((_hlslcc_mtx4x4unity_ObjectToWorld[0].yzx * _in_TANGENT0.xxx) + _u_xlat2.xyz));
(_u_xlat2.xyz = ((_hlslcc_mtx4x4unity_ObjectToWorld[2].yzx * _in_TANGENT0.zzz) + _u_xlat2.xyz));
(_u_xlat12 = dot(_u_xlat2.xyz, _u_xlat2.xyz));
(_u_xlat12 = rsqrt(_u_xlat12));
(_u_xlat2.xyz = (vec3_ctor(_u_xlat12) * _u_xlat2.xyz));
(_u_xlat16_3.xyz = (_u_xlat1.xyz * _u_xlat2.xyz));
(_u_xlat16_3.xyz = ((_u_xlat1.zxy * _u_xlat2.yzx) + (-_u_xlat16_3.xyz)));
(_u_xlat12 = (_in_TANGENT0.w * _unity_WorldTransformParams.w));
(_u_xlat16_3.xyz = (vec3_ctor(_u_xlat12) * _u_xlat16_3.xyz));
(_vs_TEXCOORD4.y = _u_xlat16_3.x);
(_vs_TEXCOORD4.w = _u_xlat0.x);
(_vs_TEXCOORD4.x = _u_xlat2.z);
(_vs_TEXCOORD4.z = _u_xlat1.y);
(_vs_TEXCOORD5.x = _u_xlat2.x);
(_vs_TEXCOORD6.x = _u_xlat2.y);
(_vs_TEXCOORD5.z = _u_xlat1.z);
(_vs_TEXCOORD6.z = _u_xlat1.x);
(_vs_TEXCOORD5.y = _u_xlat16_3.y);
(_vs_TEXCOORD6.y = _u_xlat16_3.z);
