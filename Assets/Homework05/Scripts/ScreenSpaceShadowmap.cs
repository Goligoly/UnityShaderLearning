...
public class ScreenSpaceShadowmap : BaseShadowCamera
{
    ...
    protected Matrix4x4 lightSpaceMatrix;
    ...
    void Update()
    {
        ...
        ShadowTextureRender(lightSpaceDepthTexture, ref lightSpaceMatrix);
    ...
    protected void GenerateSSSM()
    {
        ...
        SSSMGenerator.SetFloat("_PCF_Range", PCFRange);
