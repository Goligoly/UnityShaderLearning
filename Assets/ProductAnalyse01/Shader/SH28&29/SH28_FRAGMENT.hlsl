...
(_u_xlat16_2.xy = (_vs_TEXCOORD0.zw * float2(1.0, -1.0)));
(_u_xlat10.xy = ((_u_xlat16_2.xy * vec2_ctor(__BumpScale)) + _u_xlat0.zw));
(_u_xlat0.xy = ((_vs_TEXCOORD0.zw * vec2_ctor(__BumpScale)) + _u_xlat0.xy));
...
(_u_xlat16_0.xy = gl_texture2D(__MainTex, _vs_TEXCOORD0.xy).xy);
...
(_u_xlat16_4.x = dot(_vs_TEXCOORD4.xyz, _u_xlat16_2.xyz));
(_u_xlat16_4.y = dot(_vs_TEXCOORD5.xyz, _u_xlat16_2.xyz));
(_u_xlat16_4.z = dot(_vs_TEXCOORD6.xyz, _u_xlat16_2.xyz));
...
(_u_xlat16_17 = dot((-_vs_TEXCOORD1.xyz), _u_xlat16_2.xyz));
(_u_xlat16_17 = (_u_xlat16_17 + _u_xlat16_17));
(_u_xlat16_8.xyz = ((_u_xlat16_2.xyz * (-vec3_ctor(_u_xlat16_17))) + (-_vs_TEXCOORD1.xyz)));
...
(_u_xlat16_4.xyz = (_vs_TEXCOORD1.xyz + _vs_TEXCOORD7.xyz));
...
(_u_xlat16_2.x = dot(_u_xlat16_2.xyz, _vs_TEXCOORD1.xyz));
(_u_xlat16_2.x = clamp(_u_xlat16_2.x, 0.0, 1.0));
(_u_xlat16_2.x = ((-_u_xlat16_2.x) + 1.0));
(_u_xlat16_7.x = dot(_vs_TEXCOORD7.xyz, _u_xlat16_4.xyz));
...
(_u_xlat16_4.xy = _vs_TEXCOORD2.xy);
(_u_xlat16_4.xy = clamp(_u_xlat16_4.xy, 0.0, 1.0));
(_u_xlat16_2.x = ((-_u_xlat16_4.x) + 1.0));
(_u_xlat16_14.xy = (_u_xlat16_2.xx * _vs_TEXCOORD2.zw));
